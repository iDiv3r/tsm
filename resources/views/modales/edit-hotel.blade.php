<!-- Main modal -->
<div id="modal-edit-hotel" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 border border-t-orange-500 border-t-4">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="modal-edit-hotel">
            ...
            <!-- Modal body -->
            <form  action="{{ route('editarHotel') }}" method="POST" class="p-4 md:p-5">
            @csrf
                <div class="grid gap-4 mb-3">
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <small> {{ $errors->first('txtDireccion') }}</small>
                        </div>
                        <div class="col-span-2">
                        ...
                        <div>
                            ...
                            <small> {{ $errors->first('floatDistancia') }} </small>
                        </div>
                        <div>
                            ...
                            <small> {{ $errors->first('intHabitaciones') }} </small>
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Adultos</label>
                            <input type="number" name="intAdultos" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ old('intAdultos')}}">
                            <small> {{ $errors->first('intAdultos') }} </small>
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Niños</label>
                            <input type="number" name="intNinos" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ old('intNinos')}}">
                            <small> {{ $errors->first('intNinos') }} </small>
                        </div>
                        <div>
                            ...
                            <small> {{ $errors->first('floatPrecio') }} </small>
                        </div>
                        <div class="col-span-2">
                            ...
                            <small> {{ $errors->first('txtDescripcion') }} </small>
                        </div>
                        <div class="col-span-2">
                ...
                <button type="submit" class= " text-white flex   justify-self-center bg-indigo-600 hover:bg-indigo-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
