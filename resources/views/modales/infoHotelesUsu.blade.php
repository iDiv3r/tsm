            ...
            <div class="p-10 space-y-4">
                ...
                <div class="flex">
                    ...
                    <div class="w-2/5 flex flex-col items-center h-min  px-5">
                        ...
                        <div id="date-range-picker-{{$hotel->id}}" date-rangepicker class="flex flex-col items-center text-center justify-center">
                            ...
                            <div class="relative max-w-sm w-2/3 mb-4">
                                ...
                                <input id="datepicker-range-start-{{ $hotel->id}}" name="start" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Inicio" >
                            </div>
                            ...
                            <div class="relative max-w-sm mb-4 w-2/3">
                                ...
                                <input id="datepicker-range-end-{{ $hotel->id}}" name="end" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Fin" >
                            </div>
                        </div>
                ...
                <div class="border-t-4 border-t-orange-800 p-8">
                    ...
                    <div class="flex justify-between    ">
                        ...
                        <!-- Modal toggle -->
                        <button data-modal-target="agregar-comentario-{{ $hotel->id }}" data-modal-toggle="agregar-comentario-{{ $hotel->id }}" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center " type="button" data-modal-hide="info-hotel-{{ $hotel->id }}">
                            Agregar Comentario
                        </button>
                    ...
                    @foreach($comentarios as $comentario) 
                        @if($comentario->hotel_id == $hotel->id)
                            ...
                            <div class="flex mt-5">
                                ...
                                <div class="w-3/4">
                                    ...
                                    <x-static_star_rating rating="{{ $comentario->calificacion }}"></x-static_star_rating>
                                    <p class="mt-2">
...
@include('modales.agregarComentarioHotel')