...
<div id="small-modal" tabindex="-1"
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="">
                <form action="{{ route('rutaFiltrarVuelo') }}" method="POST">
                    @csrf
                    <ul class="space-y-2 font-medium  p-6">
                        <li class="mb-4 ">

                            <h6 class="mb-2 w-72 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Precio
                            </h6>

                            <div class="relative mb-6">
                                <label for="labels-range-input" class="sr-only">Labels range</label>

                                <input id="labels-range-input" name="rango" type="range" value="1000"
                                    min="100" max="1500"
                        ...
                        <li class="border-t-2 border-orange-500 dark:border-gray-700 mb-4 ">
                            ...
                            <h6 class="mb-2 w-72 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Salida
                            </h6>
                                ...
                                <div class="max-w-sm mx-auto">
                                    <div class="flex">
                                        <button id="origen-button" data-dropdown-placement="left"
                                            data-dropdown-toggle="dropdown-origen"
                                        ...
                                        <div id="dropdown-origen"
                                            class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                            <ul class="h-64 py-2 text-sm text-gray-700 dark:text-gray-200 overflow-y-auto"
                                ...
                                <div class="max-w-sm mx-auto">
                                    <div class="flex">
                                        <button id="destino-button" data-dropdown-placement="left"
                                            data-dropdown-toggle="dropdown-destino"
                                            class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                                            type="button">
                                            Pais
                                            <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true"
                            ...
                            <div class="flex flex-col">
                                <div class="flex justify-center items-center">
                                    <input id="checked-checkbox" type="checkbox"
                                        ...
                                        name="escala" value="1">
                                    <label for="checked-checkbox"
                                        class="ms-2 text-lg font-medium text-gray-900 dark:text-gray-300">Escala</label>
                                </div>
                            </div>
                        </li>
                        <li class="border-t-2 border-orange-500 dark:border-gray-700 py-4 mt-4">
                            <div class="flex items-center mt-5">
                                <button
                                    class="text-white bg-lime-600 hover:bg-lime-800 focus:ring-green-300 focus:outline-none focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                                    type="submit">
                                    Aplicar
                                </button>
                                <button
                                    class="text-white bg-amber-500 hover:bg-amber-800 focus:ring-green-300 focus:outline-none focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 ml-4"
                                    type="button" onclick="window.location='{{ route("rutaAdminVuelos") }}'">
                                    Restablecer
                                </button>
                            </div>
