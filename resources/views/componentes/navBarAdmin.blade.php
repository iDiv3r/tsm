...
{{-- Off Canvas Drawer --}}
<div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-[#222D32] w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
        <h5 id="drawer-label" class=" items-center  w-full mb-4 text-center font-semibold text-white dark:text-gray-400  ">Administrador</h5>
        ...
        <div class="">
            <div class="h-full px-3 py-4 overflow-y-auto bg-[#222D32] dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="#" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#EEC14E] dark:hover:bg-gray-700 group">
