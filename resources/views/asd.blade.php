...
{{-- 
<div class="flex">
   <span class="hover:text-red-500  text-9xl ">h</span>
   <span class="hover:text-yellow-500 text-9xl ">o</span>
   <span class="hover:text-green-500  text-9xl ">l</span>
   <span class="hover:text-blue-500  text-9xl ">a</span>
</div>
