...
@section('content')
        ...
        <div class="container pt-10 ms-10 me-20 ">
            <div class="flex justify-between items-center">
                ...
                <button data-modal-target="small-modal" data-modal-toggle="small-modal" type="button"
                    class="h-min text-white bg-orange-400 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  focus:outline-none">
                        ...
                        @foreach ($vuelos as $vuelo)
                            <tr
                                ...
                                <td class="">
                                    ...
                                    <button id="dropdownBottomButton-{{ $vuelo->id }}"
                                        data-dropdown-toggle="dropdownBottom-{{ $vuelo->id }}"
                                        data-dropdown-trigger="click" data-dropdown-placement="top"
                                        class=" mb-3 md:mb-0 text-black  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                        type="button">Opciones
            ...
            @foreach ($vuelos as $vuelo)
                <!-- Dropdown menu -->
                <div id="dropdownBottom-{{ $vuelo->id }}"
                    class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-32 dark:bg-gray-700 border-gray-200 border-2">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownBottomButton">
                        <li>
                            <a href="#" data-modal-target="editar-vuelo-{{ $vuelo->id }}"
                                data-modal-toggle="editar-vuelo-{{ $vuelo->id }}"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-sky-500">Editar</a>
                        </li>
                        <li>
                            <a href="#" data-modal-target="eliminar-vuelo-{{ $vuelo->id }}"
                                data-modal-toggle="eliminar-vuelo-{{ $vuelo->id }}"
            ...
            <button data-modal-target="agregarVuelo" data-modal-toggle="agregarVuelo"
                class="block text-white bg-green-700 hover:bg-green-800   focus:ring-green-300-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mt-5"
                type="button">
                Agregar vuelo
            </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const dropdownOrigen = document.getElementById('dropdown-origen');
